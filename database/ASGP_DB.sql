-- =============================================
-- Script de Base de Datos ASGP
-- Sistema de Administración y Gestión de Productos
-- =============================================
...
-- SELECT P.*, S.CANTIDAD_DEPOSITO, S.CANTIDAD_SUCURSAL 
-- FROM PRODUCTOS P 
-- LEFT JOIN STOCK S ON P.ID = S.ID_PRODUCTO;

-- Ver todas las ventas con detalles
-- SELECT V.*, U.NOMBRE_COMPLETO, P.NOMBRE 
-- FROM VENTAS V 
-- INNER JOIN USUARIOS U ON V.ID_USUARIO = U.ID 
-- INNER JOIN PRODUCTOS P ON V.ID_PRODUCTO = P.ID;

PRINT '✅ Base de datos ASGP_DB creada e inicializada correctamente';
